...
module.exports = function (RED) {
    ...
    function QsysCoreNode(n) {
        ...
        let changeGroup = [{ 'autoPoll': false, 'params': { 'Id': 'group 1', 'Rate': parseFloat(n.pollTime1) }},
        ...
        this.autoPoll = (index, controlId) => {
            this.sendToCore({
                "jsonrpc": "2.0",
                "id": 1234,
                "method": "ChangeGroup.AddControl",
                "params": {
                    "Id": changeGroup[index].params.Id,
                    "Controls": [controlId]
                }
            });

            if (!changeGroup[index].autoPoll) {
                changeGroup[index].autoPoll = true;
                this.sendToCore({
                    "jsonrpc": "2.0",
                    "id": 1234,
                    "method": "ChangeGroup.AutoPoll",
                    "params": changeGroup[index].params
                });
            }
        };
